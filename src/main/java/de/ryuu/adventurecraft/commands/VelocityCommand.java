...
public class VelocityCommand extends ACCommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        double vX = parseDouble(args[2], min, max);
        double vY = parseDouble(args[3], min, max);
        double vZ = parseDouble(args[4], min, max);
