...
public class ExplosionCommand extends ACCommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
...

        {
            ...
            CoordinateArg posX = parseCoordinate(originPos.getX(), args[0], false);
            CoordinateArg posY = parseCoordinate(originPos.getY(), args[1], false);
            CoordinateArg posZ = parseCoordinate(originPos.getZ(), args[2], false);
