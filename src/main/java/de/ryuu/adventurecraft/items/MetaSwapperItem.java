...
public class MetaSwapperItem extends ACItem {

    private static final WorldHelper.BlockRegionIterator swapFunctionINCR = new WorldHelper.BlockRegionIterator() {
        @Override
    ...
    private static final WorldHelper.BlockRegionIterator swapFunctionDECR = new WorldHelper.BlockRegionIterator() {
        @Override
        public void $(World world, IBlockState state, BlockPos pos) {
            IBlockState oldState = state;
            Block block = oldState.getBlock();
