...
import de.ryuu.adventurecraft.blocks.util.*;
import de.ryuu.adventurecraft.blocks.world.LockedDoorBlock;
import de.ryuu.adventurecraft.blocks.world.SpikeBlock;
...
public class AdventureCraftBlocks {
    ...
    private static <T extends Block, E extends TileEntity> T registerWithTE(String name, T block,
        ...
        GameRegistry.registerTileEntity(tileEntityClass, new ResourceLocation("assets/adventurecraft", name));
        return returnBlock;
    }
