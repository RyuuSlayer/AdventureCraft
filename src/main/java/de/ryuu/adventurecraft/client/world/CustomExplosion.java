package de.ryuu.adventurecraft.client.world;
...
public class CustomExplosion extends Explosion {
    ...
    public void collectBlocksAndDamageEntities() {
            ...
            for (int_3 = 0; int_3 < 16; ++int_3) {
                for (int_4 = 0; int_4 < 16; ++int_4) {
                    if (int_2 == 0 || int_2 == 15 || int_3 == 0 || int_3 == 15 || int_4 == 0 || int_4 == 15) {
                        double double_1 = (float) int_2 / 15.0F * 2.0F - 1.0F;
                        double double_2 = (float) int_3 / 15.0F * 2.0F - 1.0F;
                        double double_3 = (float) int_4 / 15.0F * 2.0F - 1.0F;
        ...
        List<Entity> list_1 = this.world.getEntities(this.entity, new Box(int_3, int_7, int_9, int_4, int_8, int_10));
        Vec3d vec3d_1 = new Vec3d(this.x, this.y, this.z);

        for (int int_11 = 0; int_11 < list_1.size(); ++int_11) {
            Entity entity_1 = list_1.get(int_11);
            double double_8 = MathHelper.sqrt(entity_1.squaredDistanceTo(new Vec3d(this.x, this.y, this.z))) / float_4;
            if (double_8 <= 1.0D) {
                ...
                if (double_12 != 0.0D) {
                    ...
                    double_10 /= double_12;
                    double_11 /= double_12;
                    double double_13 = getExposure(vec3d_1, entity_1);
