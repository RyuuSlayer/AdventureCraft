...
import de.ryuu.adventurecraft.client.gui.qad.QADNumberTextField;
...
public class PanelAI extends NPCPanel {
    ...
    private static class AggroListModelItem implements ListModelItem {
        ...
        private final EntityNPC.NPCType type;

        public AggroListModelItem(EntityNPC.NPCType type) {
            this.type = type;
        }
    ...
    private class AggroListModel implements ListModel {
        ...
        public AggroListModel() {
            for (EntityNPC.NPCType type : EntityNPC.NPCType.values()) {
