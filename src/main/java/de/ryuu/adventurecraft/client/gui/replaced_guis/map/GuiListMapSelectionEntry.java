...
import de.ryuu.adventurecraft.client.gui.misc.GuiWorldInfo;
...
public class GuiListMapSelectionEntry implements GuiListExtended.IGuiListEntry {
    ...
    public GuiListMapSelectionEntry(GuiListMapSelection newGuiListWorldSelection, WorldSummary worldSummaryIn,
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
        ...
        final File worldDat = new File("./" + this.containingListSel.worldPathName + "/"
                + this.worldSummary.getFileName() + "/assets/adventurecraft/info.dat");
        String s1;
        try {
    ...
    public void joinWorld() {
        ...
        } else if (worldComp != null && worldComp.hasKey("allowedUUIDs")
                && !worldComp.getString("allowedUUIDs").trim().equals("*")) {
        ...
        this.client.displayGuiScreen(new GuiYesNo((result, id) -> {
            if (result) {
                ...
                ISaveFormat isaveformat = new AnvilSaveConverter(
                        new File(GuiListMapSelectionEntry.this.client.mcDataDir,
                                GuiListMapSelectionEntry.this.worldPathName),
                        GuiListMapSelectionEntry.this.client.getDataFixer());
    ...
    public void editWorld() {
        ...
        if (worldComp != null && worldComp.hasKey("allowedUUIDs")
                && !worldComp.getString("allowedUUIDs").trim().equals("*")) {
            for (String UUID : worldComp.getString("allowedUUIDs").split(";")) {
                if (UUID.equals(Minecraft.getMinecraft().getSession().getPlayerID())) {
