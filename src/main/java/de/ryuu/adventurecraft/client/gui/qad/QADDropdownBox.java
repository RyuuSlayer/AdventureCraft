...
public class QADDropdownBox extends QADRectangularComponent {
    ...
    public void handleMouseInput() {
        ...
        if (amount < 0) {
            ...
            dropbox_scroll += amount;
            if (dropbox_scroll > dropbox_model.getFilteredItems().size() - dropbox_rowcount)
                dropbox_scroll = dropbox_model.getFilteredItems().size() - dropbox_rowcount < 0 ? 0
                        : dropbox_model.getFilteredItems().size() - dropbox_rowcount;
        }
    }
...
//				default:color = 0xFF101010;break;
            ...
            renderer.drawRectangle(this.fieldbox_x, this.fieldbox_y, this.fieldbox_x + this.fieldbox_width,
                    this.fieldbox_y + this.fieldbox_height, 0xFF000000);
            renderer.drawLineRectangle(this.fieldbox_x, this.fieldbox_y, this.fieldbox_x + this.fieldbox_width,
                    this.fieldbox_y + this.fieldbox_height, color);

            renderer.pushScissor(this.fieldbox_x + 1, this.fieldbox_y + 1, this.fieldbox_width - 2,
                    this.fieldbox_height - 2);
            ...
            if (isFocused) {
                ...
                renderer.drawRectangle(strp + 0, this.fieldbox_y + 14, strp + 5, this.fieldbox_y + 15,
...
//				default:color = 0xFF101010;break;
    ...
    public boolean isPointInside(int mouseX, int mouseY) {
        boolean inside = mouseX >= this.fieldbox_x && mouseY >= this.fieldbox_y
                && mouseX <= this.fieldbox_x + this.fieldbox_width
                && mouseY <= (dropbox_visible ? (this.dropbox_y + this.dropbox_height)
                : (this.fieldbox_y + this.fieldbox_height));
        return inside;
    }
