package de.ryuu.adventurecraft.client.gui.replaced_guis.save;
...
public class SaveSelector extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.selectionList = new GuiListSaveSelection(this, this.mc, this.width, this.height, 32, this.height - 64, 36,
                this.worldPathName);
        this.postInit();
    }
    ...
    public void postInit() {
        this.selectButton = this.addButton(new GuiButtonExt(1, this.width / 2 - 154, this.height - 52, 150, 20,
                I18n.format("Play selected Save")));
        this.addButton(
                new GuiButtonExt(3, this.width / 2 + 4, this.height - 52, 150, 20, I18n.format("Create new Save")));
//        this.renameButton = this.addButton(new GuiButtonExt(4, this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.edit")));
        this.deleteButton = this.addButton(
                new GuiButtonExt(2, this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.delete")));
        this.copyButton = this
                .addButton(new GuiButtonExt(5, this.width / 2 - 76, this.height - 28, 152, 20, I18n.format("Info")));
