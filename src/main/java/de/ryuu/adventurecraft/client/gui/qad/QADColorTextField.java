...
import de.ryuu.adventurecraft.client.gui.qad.model.DefaultTextFieldModel;
 ...
 * The only things that are changed are:<br>
 * 1. This text field allows you to use color codes<br>
 * 2. It shows all color codes below after entering an '\u00A7'
 */
public class QADColorTextField extends QADRectangularComponent {
    ...
    public int width;
    public int height;
    private QADTextField.TextFieldModel model;
    ...
    public QADColorTextField(/*int __id__, */ FontRenderer FNTREN, int xPos, int yPos, int width, int height) {
        // this.ID = __id__;
    ...
    public QADColorTextField(int xPos, int yPos, int width, int height) {
        // this.ID = __id__;
        this.model = new DefaultTextFieldModel();
    ...
    public QADColorTextField(int xPos, int yPos, int width, int height, String text) {
        // this.ID = __id__;
    ...
    public QADColorTextField(String text) {
        // this.ID = __id__;
        this.model = new DefaultTextFieldModel(text);
        this.fontRendererInstance = Minecraft.getMinecraft().fontRenderer;
        this.xPosition = 0;
    ...
    public QADColorTextField(QADTextField.TextFieldModel model) {
        // this.ID = __id__;
        this.model = model;
        this.fontRendererInstance = Minecraft.getMinecraft().fontRenderer;
        this.xPosition = 0;
    ...
    public QADTextField.TextFieldModel getModel() {
        return this.model;
    }

    public void setModel(QADTextField.TextFieldModel newModel) {
        if (newModel == null)
    ...
    public void draw(int localMouseX, int localMouseY, float partialTicks, VCUIRenderer renderer) {
        ...
        if (this.getVisible()) {
            ...
            if (autoCompleteOptions != null && isFocused && cursorOffset != 0 && (getText().charAt(cursorOffset - 1) == '\u00A7')) {
...
//		System.out.println("\u3432");
        newText = newText.replace("\u00A7", "\u3432");
        String s1 = "";
    ...
    public interface TextChangeListener {
        void call(QADColorTextField qadTextField, String text);
    }
