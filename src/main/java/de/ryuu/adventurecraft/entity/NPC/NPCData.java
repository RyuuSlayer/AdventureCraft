...
import de.ryuu.adventurecraft.entity.NPC.quest.NPCQuest;
...
public class NPCData {
     ...
     */
    private EntityNPC.NPCType type;
    ...
    public NPCData(EntityNPC npc) {
        ...
        customskin = "";
        type = EntityNPC.NPCType.Passive;
        model = EnumNPCModel.Player;
        attackDamage = 2f;
        health = 10f;
        movementspeed = 0.6D;
        nameColor = EntityNPC.NPCType.Passive.color;
    ...
    public static NPCData fromNBT(EntityNPC npc, NBTTagCompound tag) {
        ...
        data.setType(EntityNPC.NPCType.values()[tag.getInteger("type_id")]);
    ...
    public EntityNPC.NPCType getType() {
        return type;
    }

    public void setType(EntityNPC.NPCType typ) {
        type = typ;
    }
