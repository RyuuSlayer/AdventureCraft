...
import de.ryuu.adventurecraft.client.entity.npc.model.NPCModelData;
import de.ryuu.adventurecraft.entity.NPC.NPCInventoryData.NPCDrop;
import de.ryuu.adventurecraft.invoke.*;
import de.ryuu.adventurecraft.network.packets.NPCDataUpdatePacket;
...
public class EntityNPC extends EntityCreature implements IEntityAdditionalSpawnData, IInvokeSource {
    ...
    public EnumActionResult applyPlayerInteraction(EntityPlayer player, Vec3d vec, EnumHand hand) {
        ...
        if (stack == null || stack.getItem() != AdventureCraftItems.npceditor) {
    ...
    private void handleRegularInteraction(EntityPlayer player, Vec3d vec, ItemStack stack, EnumHand hand,
        ...
        if (server) {
            ...
            if (!scriptInvoke.getScriptName().isEmpty()) {
                scope = AdventureCraft.globalScriptManager.createNewNPCScope(this, stack, player);
    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (!scriptInvoke.getScriptName().isEmpty()) {
                scope = AdventureCraft.globalScriptManager.createNewNPCScope(this);
                Invoke.invoke(scriptInvoke, this, null, EnumTriggerState.IGNORE);
            }
        }
