package de.ryuum3gum1n.adventurecraft.container;
...
public class WorkbenchContainer extends ContainerWorkbench {
	...
	public WorkbenchContainer(InventoryPlayer player, World worldObj, BlockPos pos) {
		...
		this.addSlotToContainer(
				new SlotWorkbenchCrafting(player.player, this.craftMatrix, this.craftResult, 0, 124, 35));
	...
	public boolean canInteractWith(EntityPlayer playerIn) {
		return this.worldObj.getBlockState(this.pos).getBlock() != AdventureCraftBlocks.workbench ? false
	...
	public static class SlotWorkbenchCrafting extends SlotCrafting {
		...
		public SlotWorkbenchCrafting(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventoryIn,
