...
public class WorkbenchContainer extends ContainerWorkbench {
	...
	@Override
		...
		return this.worldObj.getBlockState(this.pos).getBlock() != AdventureCraftBlocks.workbench ? false : playerIn.getDistanceSq((double)this.pos.getX() + 0.5D, (double)this.pos.getY() + 0.5D, (double)this.pos.getZ() + 0.5D) <= 64.0D;
	}
