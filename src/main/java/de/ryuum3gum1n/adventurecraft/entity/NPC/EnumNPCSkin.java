package de.ryuum3gum1n.adventurecraft.entity.NPC;
...
public enum EnumNPCSkin {
	...
	Green_Steve(new ResourceLocation("adventurecraft:textures/entity/NPC/player/greensteve.png"),  EnumNPCModel.Player),
	Red_Steve(new ResourceLocation("adventurecraft:textures/entity/NPC/player/redsteve.png"),  EnumNPCModel.Player),
	Invisible(null,  null),
	Villager(new ResourceLocation("adventurecraft:textures/entity/NPC/player/villager.png"),  "NicoKing60", EnumNPCModel.Player),
	Modern_Female(new ResourceLocation("adventurecraft:textures/entity/NPC/player/modern_female.png"), "NicoKing60", EnumNPCModel.Player),
	Knight(new ResourceLocation("adventurecraft:textures/entity/NPC/player/knight.png"),  "WinterWolfee", EnumNPCModel.Player),
	Knight2(new ResourceLocation("adventurecraft:textures/entity/NPC/player/knight2.png"),  "WinterWolfee", EnumNPCModel.Player),
	Huntress(new ResourceLocation("adventurecraft:textures/entity/NPC/player/huntress.png"),  "WinterWolfee", EnumNPCModel.Player),
	Farmer(new ResourceLocation("adventurecraft:textures/entity/NPC/player/farmer.png"),  "WinterWolfee", EnumNPCModel.Player),
	Priest(new ResourceLocation("adventurecraft:textures/entity/NPC/player/priest.png"),  "WinterWolfee", EnumNPCModel.Player),
