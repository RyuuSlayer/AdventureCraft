...
public class MountCommand extends ACCommandBase {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if (rider.getRidingEntity() != null) {
			throw new CommandException("Rider is already mounting another entity.", sender, rider,
					rider.getRidingEntity());
		}

		if (!mount.getPassengers().isEmpty()) {
			throw new CommandException("Mount is already mounted by another entity.", sender, mount,
					mount.getPassengers());
		}
