...
public class GuiMapControl extends QADGuiScreen {
	...
	public void buildGui(ArrayList<QADComponent> components) {
		...
		// field.autoCompleteOptions = new
		// String[]{"This","Is","Text","Great!","abcdefghijklmnopqrstuvwxyz"};
		// components.add(field);

		/*
		 * QADButtonBox box = new QADButtonBox( new QADButton(0, 0, 160-4,
		 * "Weather, Clear"), new QADButton(0, 0, 160-4, "Weather, Rain"), new
		 * QADButton(0, 0, 160-4, "Weather, Thunder") ); box.setPosition(2, 24);
		 * box.setSize(160, 20*8); components.add(box); //
		 */
