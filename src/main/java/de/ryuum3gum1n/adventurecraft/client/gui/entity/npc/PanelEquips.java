...
import de.ryuum3gum1n.adventurecraft.client.gui.qad.QADDropdownBox;
import de.ryuum3gum1n.adventurecraft.client.gui.qad.QADDropdownBox.ListModel;
import de.ryuum3gum1n.adventurecraft.client.gui.qad.QADDropdownBox.ListModelItem;
...
public class PanelEquips extends NPCPanel {
	...
	public PanelEquips(NPCData data, int width, int height) {
		...
		HELMET = new QADDropdownBox(new ListItemListModel(EntityEquipmentSlot.HEAD),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.HEAD)));
		CHESTPLATE = new QADDropdownBox(new ListItemListModel(EntityEquipmentSlot.CHEST),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.CHEST)));
		LEGGINGS = new QADDropdownBox(new ListItemListModel(EntityEquipmentSlot.LEGS),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.LEGS)));
		BOOTS = new QADDropdownBox(new ListItemListModel(EntityEquipmentSlot.FEET),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.FEET)));
		RIGHT_HAND = new QADDropdownBox(new ListItemListModel(null),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.MAINHAND)));
		LEFT_HAND = new QADDropdownBox(new ListItemListModel(null),
				new ItemItem(data.getInvStack(EntityEquipmentSlot.OFFHAND)));
