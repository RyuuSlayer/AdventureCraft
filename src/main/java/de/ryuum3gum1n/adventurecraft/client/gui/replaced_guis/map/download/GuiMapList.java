...
public class GuiMapList extends GuiScreen {
    ...
    public void postInit() {
        this.selectButton = this.addButton(new GuiButtonExt(1, this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("More Details")));
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 1:
                ...
                break;//GuiMainMenu
            case 2:
                GuiConfirmOpenLink guiconfirmopenlink = new GuiConfirmOpenLink(this, "https://docs.google.com/forms/d/e/1FAIpQLSeKj7ADdys2tnl3iGQ7oCGCnrCp5QQhhAcIhDHZWcHFEJMkPg/viewform?usp=sf_link", 13, true);
        ...
        if (id == 13) {
            if (result) {
                try {
                    ...
                    oclass.getMethod("browse", URI.class).invoke(object, new URI("https://docs.google.com/forms/d/e/1FAIpQLSeKj7ADdys2tnl3iGQ7oCGCnrCp5QQhhAcIhDHZWcHFEJMkPg/viewform?usp=sf_link"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(fontRenderer, "Showing " + this.selectionList.entries.size() + (this.selectionList.entries.size() == 1 ? " Map" : " Maps"), width / 2 + 30, height - 20, 16777215);
    ...
    protected void keyTyped(char typedChar, int keyCode) {
        ...
        if (!txt.equals(searchField.getText())) this.selectionList.refreshList();
    }
