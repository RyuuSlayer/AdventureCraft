...
public class GuiMapListSelection extends GuiListExtended {
    ...
    public GuiMapListSelection(GuiMapList p_i46590_1_, Minecraft clientIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn, GuiTextField search) {
