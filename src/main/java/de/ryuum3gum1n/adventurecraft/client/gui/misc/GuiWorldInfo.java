...
import de.ryuum3gum1n.adventurecraft.client.gui.replaced_guis.CustomMainMenu;
...
public class GuiWorldInfo extends QADGuiScreen {
	...
	public GuiWorldInfo(WorldSummary worldSummary, GuiScreen worldSelScreen, String pathName) {
		...
		final File worldDat = new File("./" + pathName + "/" + this.ws.getFileName() + "/adventurecraft/info.dat");
		String s1;
		try {
