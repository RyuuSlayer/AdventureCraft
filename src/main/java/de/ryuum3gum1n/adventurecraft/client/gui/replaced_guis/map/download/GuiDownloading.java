            ...
            if ((unzipOnly || zip.getStatus() == DownloadZip.COMPLETE)) {
                ...
                new Thread(() -> {
                    ...
                    try {
                        ...
                        ZipInputStream zis =
                                new ZipInputStream(new FileInputStream(unzipOnly ? new File(new File(mc.mcDataDir, "saves/.AC_DOWNLOADS"), fileName) : zip.getFile()));
                        ...
                        if (!new File("./saves/.AC_MAPS/" + outDir + "/adventurecraft").exists())
                            new File("./saves/.AC_MAPS/" + outDir + "/adventurecraft").mkdirs();
                        File mapInfoFile = new File("./saves/.AC_MAPS/" + outDir + "/adventurecraft/info.dat");
