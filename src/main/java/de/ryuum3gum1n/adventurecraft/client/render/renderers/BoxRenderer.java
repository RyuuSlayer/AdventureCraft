package de.ryuum3gum1n.adventurecraft.client.render.renderers;
...
public class BoxRenderer {
	...
	public static final void renderBoxLine(Tessellator tessellator, BufferBuilder vertexbuffer,
		...
		for(float t = AdventureCraft.asClient().getRenderer().getLastPartialTicks() / 3f, step = 1f / 3f; t < length; t += step) {
			tx = x0 + nx*t;
			ty = y0 + ny*t;
			tz = z0 + nz*t;
