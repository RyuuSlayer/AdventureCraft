...
public class Environment {
	...
	public static class Fog {
		...
		@Override
		public String toString() {
			return String.format("{start: %s, end: %s, density: %s, color: %s}", start, end, density,
	...
	public static class CloudLayer {
		...
		public String texture = "adventurecraft:environments/example/clouds.png";
	...
	public static class SkyLayer {
		...
		public String texture = "adventurecraft:environment/noise.png";
		...
		@Override
		public String toString() {
			return String.format("{blend: %s, depth: %s, shape: %s, origin: %s, offset: %s, scale: %s, rotation: %s}",
					blend, depth, shape, origin, Arrays.toString(offset), scale, rotation);
		}
