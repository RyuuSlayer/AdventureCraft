	...
	public static class Serializer {
		...
		public static final IScriptInvoke readSI(NBTTagCompound compoundTag) {
			...
			if(invoke instanceof IScriptInvoke) {
				// AdventureCraft.logger.info("Loaded IScriptInvoke : " + invoke.getType() + " : " + ((IScriptInvoke)invoke).getScriptName());
				return (IScriptInvoke) invoke;
			}

			AdventureCraft.logger.error("Invalid Invoke Object! Required is IScriptInvoke, given is " + invoke.getType() + "!");
