package de.ryuum3gum1n.adventurecraft.particles;
...
public class BlockEffect extends Barrier {
	...
	public BlockEffect(World worldIn, double x, double y, double z, Block block) {
		...
		//		TextureAtlasSprite sprite = ACTextureAtlasSprite.create(new ResourceLocation(Reference.MOD_NAME.toLowerCase(), "textures/blocks/util/light.png"));
