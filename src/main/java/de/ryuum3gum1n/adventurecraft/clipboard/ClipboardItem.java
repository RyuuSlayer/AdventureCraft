package de.ryuum3gum1n.adventurecraft.clipboard;

import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$ENTITY;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$OFFSET;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_DATA;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_DYNAMIC_DATA;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_HEIGHT;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_LENGTH;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_PALLET;
import static de.ryuum3gum1n.adventurecraft.clipboard.ClipboardTagNames.$REGION_WIDTH;
...
public class ClipboardItem {
	...
	public static ClipboardItem copyRegion(int[] bounds, World world, String name, ICommandSender player) {
		...
		// AdventureCraft.logger.info("-      Size: " + regionWidth + " " + regionHeight + " " + regionLength);
