...
import de.ryuum3gum1n.adventurecraft.script.wrappers.block.BlockObjectWrapper;
import de.ryuum3gum1n.adventurecraft.script.wrappers.block.BlockStateObjectWrapper;
import de.ryuum3gum1n.adventurecraft.script.wrappers.block.WorkbenchObjectWrapper;
...
import de.ryuum3gum1n.adventurecraft.script.wrappers.scoreboard.ScoreboardObjectWrapper;
...
import de.ryuum3gum1n.adventurecraft.util.WorldCommandSender;
...
public class WorldObjectWrapper implements IObjectWrapper {
	...
	public Object eval(String script) {
		...
		return AdventureCraft.globalScriptManager.interpret(script, "<?>", worldScope);
	}
